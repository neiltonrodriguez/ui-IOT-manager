<template>
    <div>
        <h3 class="detalhes">DETALHES DO USUARIO</h3>
    </div>
        ...
        <form class="row g-3" v-on:submit.prevent="store(usuario)">
            ...
            <div class="grid gap-3 mb-3 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select v-model="usuario.empresa" @change="habilitarSalvar()" class="input-form">
            ...
            <div class="grid gap-3 mb-3 md:grid-cols-2">
                ...
                <div>
                    <label class="label-form">Tipo
                        de usuário</label>
                    <select v-model="usuario.tipo" required @change="habilitarSalvar()" class="input-form">
                ...
                <div>
                    ...
                    <select v-model="usuario.is_active" class="input-form" @change="habilitarSalvar()">
            ...
            <div class="grid gap-3 mb-3 md:grid-cols-3">
                ...
                <div>
                    ...
                    <select v-model="usuario.complemento" @change="habilitarSalvar()" class="input-form">
                ...
                <div>
                    ...
                    <select v-model="usuario.departamento" @change="habilitarSalvar()" class="input-form">
            ...
            <button type="submit" v-bind:disabled="isDisabled"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 disabled:bg-gray-300 dark:focus:ring-blue-800">Salvar</button>
    ...
    methods: {
        buscarCep() {
            ...
            axios.get('http://viacep.com.br/ws/' + cepSemCaracteres + '/json/')
                .then(data => {
                    this.usuario.logradouro = data.data.logradouro,
                        this.usuario.bairro = data.data.bairro,
                        this.usuario.complemento = data.data.complemento,
                        this.usuario.cidade = data.data.localidade,
                        this.usuario.uf = data.data.uf
                }).catch(e => {
                    console.log(e);
                });
        },
        ...
        store(formD) {
            ...
            if (this.usuario.origemusuario !== "ldap") {
            ...
            http.put('/usuarios/' + this.usuario.id + '/', formData, { headers })
                .then(res => {
                    this.$swal.fire({
                        icon: 'success',
        ...
        setUsuario() {
            http.get('/usuarios/' + this.$route.params.id)
                .then(res => {
