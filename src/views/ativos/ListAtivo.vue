<template>
    <div>
        <Filtro @meu-evento="filtrar" :filterConta="true" :filterEmpresa="true"
            :filterGrupoSensor="false" :filterDepartamento="false" :filterStatus="true" :filterDepartamentoAtivo="true" />
    </div>
            ...
            <tbody class="bg-white dark:bg-slate-800">
                <tr v-for="a in ativos" :key="a.id">
                    <td class="border-b border-slate-100 dark:border-slate-700 p-4 text-slate-500 dark:text-slate-400">
                        ...
                        <template v-else>
                            <img class="rounded-lg shadow-md duration-200 hover:scale-105" :src="a.icone" width="100">
                        </template>
