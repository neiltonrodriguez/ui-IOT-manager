<template>
    <div class="border py-5 px-5 border-gray-300 rounded-lg">
        ...
        <Filtro @meu-evento="filtrar" :filterConta="false" :filterEmpresa="false"
            :filterGrupoSensor="false" :filterDepartamento="false" :filterStatus="false" />
    </div>
    <div class="shadow-sm overflow-hidden my-8">
        ...
        <table class="border-collapse table-fixed w-full text-sm">
            ...
            <tbody class="bg-white dark:bg-slate-800">
                <tr v-for="a in grupoativos" :key="a.id">
